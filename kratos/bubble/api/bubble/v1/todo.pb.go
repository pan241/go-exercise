...
const file_api_bubble_v1_todo_proto_rawDesc = "" +
	...
	"\x0fCreateTodoReply\x12'\n" +
	"\x04todo\x18\x01 \x01(\v2\x13.api.bubble.v1.todoR\x04todo\"Q\n" +
	...
	"\rListTodoReply\x12'\n" +
	"\x04data\x18\x01 \x03(\v2\x13.api.bubble.v1.todoR\x04data2\xf6\x03\n" +
	"\x04Todo\x12c\n" +
	"\n" +
	...
	"\aGetTodo\x12\x1d.api.bubble.v1.GetTodoRequest\x1a\x1b.api.bubble.v1.GetTodoReply\"\x15\x82\xd3\xe4\x93\x02\x0f\x12\r/v1/todo/{id}\x12Z\n" +
	"\bListTodo\x12\x1e.api.bubble.v1.ListTodoRequest\x1a\x1c.api.bubble.v1.ListTodoReply\"\x10\x82\xd3\xe4\x93\x02\n" +
	"\x12\b/v1/todoB*\n" +
...
var file_api_bubble_v1_todo_proto_depIdxs = []int32{
	...
	1,  // 3: api.bubble.v1.Todo.CreateTodo:input_type -> api.bubble.v1.CreateTodoRequest
	3,  // 4: api.bubble.v1.Todo.UpdateTodo:input_type -> api.bubble.v1.UpdateTodoRequest
